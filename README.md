...
| <a name="input_has_home_folder"></a> [has\_home\_folder](#input\_has\_home\_folder) | create home fodler for each user | `bool` | `false` | no |
| <a name="input_kms_arns"></a> [kms\_arns](#input\_kms\_arns) | The S3 bucket kms arns when KMS is enabled on the S3 bucket | `list(string)` | `[]` | no |
